...
export default function GetStarted() {
	return (
		...
		>
			<section className="container bg-black/60 fixed text-white top-0 left-0 h-full w-full">
				<div className="break-words h-full w-full flex flex-col justify-between lg:justify-start lg:gap-12">
					...
					<Link
						...
						className="bg-primary rounded-xl py-4 shadow-2xl shadow-primary/40 px-4
                         ...
                         transition-all duration-300 cursor-pointer mb-6 lg:w-96"
					>
						Get Started
					</Link>
				</div>
